...
if (isset($_POST['id']) and isset($_POST['nom']) and isset($_POST['dateD']) and isset($_POST['dateF']) and isset($_POST['pourcentage']) and isset($_POST['prixAncien'])and isset($_POST['idevent'])){
  
  
$promo1=new Promotion($_POST['id'],$_POST['nom'],$_POST['dateD'],$_POST['dateF'],$_POST['pourcentage'],$_POST['prixAncien'],$_POST['idevent']);
//Partie2
/*
var_dump($employe1);
}
