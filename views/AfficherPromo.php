...
foreach($listePromos as $row){
  ...
  <input type="submit" name="supprimer" OnClick="return confirm('Voulez vous vraiment supprimer cette promotion ?');" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
  </form>
  </td>
  
  <td><a href="modifierPromo.php?id=<?PHP echo $row['id']; ?>">
  Modifier</a></td>
  </tr>
  <?PHP
}
